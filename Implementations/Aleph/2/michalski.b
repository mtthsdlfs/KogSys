...
% Each first ten trains from West and Eastbound Train Generator
...
shape(car_134,rectangle). long(car_134). roof(car_134,flat_roof). load(car_134,triangle_load,3). 
...
shape(car_192,rectangle). long(car_192). roof(car_192,flat_roof). load(car_192,triangle_load,3). 
...
shape(car_202,hexagon). short(car_202). roof(car_202,flat_roof). load(car_202,triangle_load,2). 
