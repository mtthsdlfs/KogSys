...
examine(([C|Cs]),N,Z):-
                   open('trains_aleph_rek_east.txt',append,Stream),
...
examine2(N,Z) :-
               N1 is N - 1,
               open('trains_aleph_2.txt', append, Stream),
               write(Stream, "infront(east"), write(Stream,Z),write(Stream,",car_"), write(Stream,Z), write(Stream,N1), write(Stream, ",car_"), write(Stream,Z), write(Stream,N), write(Stream,")."),
               nl(Stream),
               close(Stream),
               examine2(N1,Z).
